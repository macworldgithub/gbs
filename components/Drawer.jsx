...
//         setRoleLabel(userData?.activatedPackage?.role?.label || null);
          ...
          try {
            ...
            if (selectedPackageId) {
              ...
              if (response.ok) {
                ...
                if (pkg) {
                  roleLabelFromStorage = pkg.label || pkg.name;
                }
              }
            }
          } catch (fallbackError) {
            console.error("Error fetching fallback role label:", fallbackError);
          }
        }

        setRoleLabel(roleLabelFromStorage || null);
