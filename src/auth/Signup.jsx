...
export default function Signup() {
  ...
  const handleSignup = async () => {
    try {
      ...
      const payload = {
        ...
        businessName,
        shortBio,
        interestedIn: interestsArray, // ✅ send as array
        state,
      };
  ...
  return (
    ...
    //   <View
    //     style={tw`flex-row items-center bg-white border rounded-xl px-4 py-1 mb-2`}
    //   >
    ...
    >
      <ScrollView
        contentContainerStyle={tw`px-6 pt-8 pb-20`} // 👈 scroll padding fix
