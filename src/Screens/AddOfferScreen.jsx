  ...
  return (
    <View style={tw`flex-1 bg-white`}>
      ...
      <ScrollView style={tw`flex-1 px-4`} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <LabeledInput label="Expiry Date (YYYY-MM-DD)" value={form.expiryDate} onChangeText={(t) => updateField("expiryDate", t)} placeholder="2025-03-30" />
        ...
        <LabeledInput label="Locations (comma separated)" value={(form.locations || []).join(", ")} onChangeText={(t) => updateField("locations", t.split(",").map((s) => s.trim()))} placeholder="Sydney, Melbourne" />
