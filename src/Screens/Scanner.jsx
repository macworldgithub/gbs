...
export default function Scanner() {
  ...
  return (
    <View style={tw`flex-1 bg-white `}>
      ...
      {/* QR Scanner Area */}
      <View
        style={tw`flex-1 items-center justify-center bg-gray-300 mx-4 rounded-xl mt-4`}
      >
        <View
          style={tw`w-60 h-60 bg-gray-300 rounded-xl border-4 border-white`}
        />
      ...
      <View style={tw`bg-white px-6 py-4 rounded-t-3xl shadow-md`}>
        ...
        >
          <Text style={tw`text-center text-red-500 font-semibold`}>
            Connect
          </Text>
        </TouchableOpacity>
      </View>
