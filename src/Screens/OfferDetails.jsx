...
//             multiline
//             style={tw`border border-gray-300 rounded-lg p-3 text-black-400 bg-red-400`}
//           />
...
//       const userData = await getUserData();
//       const token = userData?.token;
//       const userId = userData?._id; // assuming storage has userId as "_id"

//       const response = await axios.post(
//         `${API_BASE_URL}/offer/${id}/review/${userId}`,
//         { rating, comment },
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
...
//       // API response already returns updated offer with reviews
//       setOffer(response.data);
//     } catch (err) {
