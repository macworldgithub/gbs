...
const BusinessPage = ({ navigation }) => {
  ...
  return (
    <ScrollView ref={scrollViewRef} style={tw`flex-1 bg-gray-200 px-4 py-4`}>
      {/* Section Title */}
      <View style={tw`pt-14`}>
      ...
      {!loading && !noPackage && !noResults && businessListings.length > 0 && (
        <View
          style={[
            tw`bg-white px-6 py-4 border-t border-gray-200`,
            {
              shadowColor: "#000",
        ...
        >
          <View style={tw`flex-row items-center justify-between`}>
            ...
            <TouchableOpacity
              ...
              onPress={() => page > 1 && fetchBusinesses(page - 1, true, true)}
            ...
            {/* Current Page */}
            <View style={tw`px-5 py-2 rounded-full bg-gray-100`}>
            ...
            <TouchableOpacity
              ...
              onPress={() => hasNext && fetchBusinesses(page + 1, true, true)}
              style={tw`px-4 py-2 rounded-lg ${
