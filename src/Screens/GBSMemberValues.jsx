    ...
    <View style={tw`flex-1 bg-white`}>
      ...
      <ScrollView contentContainerStyle={tw`p-5 pb-20`}>
        ...
        <Text style={tw`text-sm text-gray-700 leading-6 mb-4`}>
          The Good Blokes Society, formed in 2014, has grown from humble
          beginnings into a community that has created lifelong friendships,
          meaningful business connections and countless memories. It provides a
          space for men to support each other and promote men’s health in a
          positive and impactful way.
        </Text>

        <Text style={tw`text-sm text-gray-700 leading-6 mb-4`}>
          As our community welcomes new members, it is important we reinforce
          the shared values that make someone a “Good Bloke.” These values have
          been naturally embraced by our members, guiding how we behave, how we
          support one another and how we continue to enjoy the GBS experience
          together.
        </Text>

        <Text style={tw`text-sm text-gray-700 leading-6 mb-6`}>
          These values are simple, but they speak to who we are individually and
          as a collective. Let’s continue to enjoy our time together, have fun
          doing it, and always remember why we connect.
        </Text>
        ...
        <Bullet>
          Be Accountable: Each of us is responsible for our words and our
          actions.
        </Bullet>
        <Bullet>
        ...
        <Bullet>
          Respect: Recognise that the thoughts, feelings and circumstances of
        ...
        <Bullet>
          Teamwork: Support each other — sometimes one of us needs a little
          help.
        </Bullet>
